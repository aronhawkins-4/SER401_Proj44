...
import https.gov_fema_ipaws_services.caprequest.RequestParameterList;
import https.gov_fema_ipaws_services.capresponse.ResponseParameterList;


/**
 * This object contains factory methods for each 
 * Java content interface and Java element interface 
 * generated in the https.gov_fema_ipaws_services.ipaws_capservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetRequestTypeDef_QNAME = new QName("https://gov.fema.ipaws.services/IPAWS_CAPService/", "getRequestTypeDef");
    private final static QName _GetResponseTypeDef_QNAME = new QName("https://gov.fema.ipaws.services/IPAWS_CAPService/", "getResponseTypeDef");
    private final static QName _GetMessageTypeDef_QNAME = new QName("https://gov.fema.ipaws.services/IPAWS_CAPService/", "getMessageTypeDef");
    private final static QName _PostCAPResponseTypeDef_QNAME = new QName("https://gov.fema.ipaws.services/IPAWS_CAPService/", "postCAPResponseTypeDef");
    private final static QName _CAPHeaderTypeDefLogonUser_QNAME = new QName("https://gov.fema.ipaws.services/IPAWS_CAPService/", "logonUser");
    private final static QName _CAPHeaderTypeDefLogonCogId_QNAME = new QName("https://gov.fema.ipaws.services/IPAWS_CAPService/", "logonCogId");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: https.gov_fema_ipaws_services.ipaws_capservice
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "https://gov.fema.ipaws.services/IPAWS_CAPService/", name = "getRequestTypeDef")
     ...
     */
    @XmlElementDecl(namespace = "https://gov.fema.ipaws.services/IPAWS_CAPService/", name = "getResponseTypeDef")
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link RequestParameterList }{@code >}
     */
    @XmlElementDecl(namespace = "https://gov.fema.ipaws.services/IPAWS_CAPService/", name = "getMessageTypeDef")
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link ResponseParameterList }{@code >}
     */
    @XmlElementDecl(namespace = "https://gov.fema.ipaws.services/IPAWS_CAPService/", name = "postCAPResponseTypeDef")
     ...
     */
    @XmlElementDecl(namespace = "https://gov.fema.ipaws.services/IPAWS_CAPService/", name = "logonUser", scope = CAPHeaderTypeDef.class)
     ...
     */
    @XmlElementDecl(namespace = "https://gov.fema.ipaws.services/IPAWS_CAPService/", name = "logonCogId", scope = CAPHeaderTypeDef.class)
