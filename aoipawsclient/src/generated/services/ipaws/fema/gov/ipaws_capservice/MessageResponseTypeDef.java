 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element ref="{urn:oasis:names:tc:emergency:cap:1.2}alert" maxOccurs="unbounded" minOccurs="0"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
@XmlRootElement(name = "messageResponseTypeDef")
public class MessageResponseTypeDef {

    @XmlElement(namespace = "urn:oasis:names:tc:emergency:cap:1.2")
