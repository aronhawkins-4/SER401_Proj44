...
export declare namespace StorageAccessFramework {
    ...
    const writeAsStringAsync: typeof import("expo-file-system/build/FileSystem").writeAsStringAsync;
    const readAsStringAsync: typeof import("expo-file-system/build/FileSystem").readAsStringAsync;
    const deleteAsync: typeof import("expo-file-system/build/FileSystem").deleteAsync;
    const moveAsync: typeof import("expo-file-system/build/FileSystem").moveAsync;
    const copyAsync: typeof import("expo-file-system/build/FileSystem").copyAsync;
}
